...
void main() {
  group('Diagnostic Probes & Generator Verification', () {
    test(
  ...
  group('HardwareValidationPage Widget Tests', () {
    testWidgets('renders diagnostic probes and protocol case sections', (
      ...
      expect(find.text('Step 1: Transport Diagnostic Probes'), findsOneWidget);
      expect(
        find.text('Step 2: Protocol Validation Test Suite'),
        findsOneWidget,
      );
